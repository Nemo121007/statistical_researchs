...
def analyze_filter_consistency(
    ...
    fig.suptitle(f"Модель Filter Kalman RW\nИсходное количество объектов: {all_count}\n"
...
if __name__ == "__main__":
    ...
    lon, lat, dt = processor.get_lon_lat(df)
    mark = df['validate_point'].values
    ...
    step = 5
    kf = KalmanFilterRW(sigma_acc=0.04, sigma_meas=1 * 2.4)
    ...
    pict_path = project_root / 'Kalman_RW.png'
