...
if __name__ == '__main__':
    ...
    n_select = len(list_valid_df) // 3

    # Выбираем случайные интервалы
    if n_select > 0:
        selected_dfs = random.sample(list_valid_df, n_select)
    else:
        selected_dfs = list_valid_df
