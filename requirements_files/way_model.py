...
from typing import List, Tuple, Union, TYPE_CHECKING, Dict, Optional
...
class Way:
    ...
    def __init__(
        ...
        self._max_lat: Optional[float] = None
        self._min_lon: Optional[float] = None
        self._max_lon: Optional[float] = None
        self._neighbor_ways: Dict[Way, List[Node]] = {}
        self._shapely_line_string: Optional[LineString] = None
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"Way(id={self._id}, name={self._tags.get('name')}, "
            f"tags={len(self._tags)}, nodes={len(self._nodes)})"
        )
    ...
    def shapely_line_string(self, line: LineString) -> None:
        ...
        self._shapely_line_string = line
